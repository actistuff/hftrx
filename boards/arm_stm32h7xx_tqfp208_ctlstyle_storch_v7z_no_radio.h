...
#ifndef ARM_STM32H7XX_TQFP208_CTLSTYLE_STORCH_V7_NO_RADIO_H_INCLUDED
#define ARM_STM32H7XX_TQFP208_CTLSTYLE_STORCH_V7_NO_RADIO_H_INCLUDED 1
	...
	//#define WITHUSESAII2S	1	/* I2S PLL	*/
		...
		#define REF3_DIV 4			// ref freq = 2.0000 MHz
			...
			#define REF3_MUL 135		// 2*135.000 MHz (192 <= PLLN <= 432)
			#define PWR_D3CR_VOS_value (PWR_D3CR_VOS_0 * 2)
...
#endif /* ARM_STM32H7XX_TQFP208_CTLSTYLE_STORCH_V7_NO_RADIO_H_INCLUDED */
